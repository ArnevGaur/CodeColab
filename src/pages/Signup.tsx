  ...
  return (
    ...
    >
      ...
      >
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <User className="absolute left-3.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground" />
            <Input
              type="text"
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <Mail className="absolute left-3.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground" />
            <Input
              type="email"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="text-[13px] font-semibold text-foreground">Confirm</label>
            <div className="relative">
              <Lock className="absolute left-3.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground" />
              <Input
                type="password"
        ...
        <div className="flex items-start gap-2.5 rounded-xl border border-white/8 bg-white/[0.03] p-3">
          <Checkbox
            id="terms"
        ...
        <Button type="submit" size="default" className="h-9 w-full accent-ring text-[13px]">
      ...
      <div className="grid gap-2.5 sm:grid-cols-2">
        <Button type="button" variant="outline" size="default" className="h-9 text-[13px]" onClick={() => handleOAuth("Google")}>
          <Chrome className="h-4 w-4" />
          Google
        </Button>
        <Button type="button" variant="outline" size="default" className="h-9 text-[13px]" onClick={() => handleOAuth("GitHub")}>
