...
const Signup = () => {
  ...
  return (
    <AuthShell
      ...
      title="Create an account and keep the flow simple."
      description="Start with a clean workspace, invite collaborators, and move straight into editing."
      footer={
        <p>
    ...
    >
      ...
      >
        <div className="space-y-2">
          ...
          <Input
            ...
            className="h-10 bg-secondary/55 text-sm"
            required
          />
        </div>
        ...
        <Button type="submit" size="default" className="h-10 w-full accent-ring">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase tracking-[0.18em] text-muted-foreground">
          <span className="bg-card px-3">Or use a demo provider</span>
        </div>
      </div>

      <div className="grid gap-2.5 sm:grid-cols-2">
        <Button type="button" variant="outline" size="default" className="h-10" onClick={() => handleOAuth("Google")}>
          <Chrome className="h-4 w-4" />
          Google
        </Button>
        <Button type="button" variant="outline" size="default" className="h-10" onClick={() => handleOAuth("GitHub")}>
